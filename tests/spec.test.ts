  ...
  describe('Account Endpoints', () => {
    ...
    it('Get Internal Transactions by Block Range', async () => {
      await runTest({
        ...
        method: c =>
          c.account.getTxListInternalBlockRange({
            startblock: 13481773,
            endblock: 13481773,
            page: 1,
            offset: 10,
    ...
    it('Get Beacon Chain Withdrawals', async () => {
      await runTest({
        ...
        method: c =>
          c.account.getTxsBeaconWithdrawal({
    ...
    it('Get Address Funded By', async () => {
      await runTest({
        name: 'fundedby',
        method: c =>
          c.account.getFundedBy({ address: '0x4838B106FCe9647Bdf1E7877BF73cE8B0BAD5f97' }),
        expectedParams: {
          module: 'account',
          action: 'fundedby',
    ...
    it('Get Historical ERC20 Token Balance', async () => {
      await runTest({
        ...
        method: c =>
          c.tokens.getTokenBalanceHistory({
            address: '0xe04f27eb70e025b78871a2ad7eabe85e61212761',
            contractaddress: '0x57d90b64a1a57749b0f932f1a3395792e12e7055',
            blockno: 8000000,
          }),
    ...
    it('Get Address ERC20 Token Holding', async () => {
      await runTest({
        ...
        method: c =>
          c.tokens.getAddressTokenBalance({
    ...
    it('Get Address ERC721 Token Holding', async () => {
      await runTest({
        ...
        method: c =>
          c.tokens.getAddressTokenNftBalance({
    ...
    it('Get Address ERC721 Token Inventory', async () => {
      await runTest({
        ...
        method: c =>
          c.tokens.getAddressTokenNftInventory({
  ...
  describe('Contract Endpoints', () => {
    ...
    it('Get Contract Source Code', async () => {
      await runTest({
        name: 'getsourcecode',
        method: c =>
          c.contract.getSourceCode({ address: '0xBB9bc244D798123fDe783fCc1C72d3Bb8C189413' }),
        expectedParams: {
          module: 'contract',
    ...
    it('Verify Proxy Contract', async () => {
      await runTest({
        ...
        method: c =>
          c.contract.verifyProxyContract({
            address: VALID_ADDRESS,
            expectedimplementation: VALID_ADDRESS,
          }),
        expectedParams: {
          module: 'contract',
    ...
    it('Verify zkSync Source Code', async () => {
      await runTest({
        ...
        method: c =>
          c.contract.verifyZkSyncSourceCode({
            contractaddress: VALID_ADDRESS,
            sourceCode: 'code',
            contractname: 'name',
    ...
    it('Get Contract Creator', async () => {
      await runTest({
        ...
        expectedParams: {
          ...
          contractaddresses: VALID_ADDRESS,
        },
        mockResponse: { status: '1', message: 'OK', result: [] },
      });
    });
  ...
  describe('Block Endpoints', () => {
    ...
    it('Get Daily Uncle Block Count', async () => {
      await runTest({
        ...
        method: c =>
          c.block.getDailyUncleBlockCount({
            startdate: '2019-02-01',
            enddate: '2019-02-28',
            sort: 'desc',
          }),
  ...
  describe('Logs Endpoints', () => {
    ...
    it('Get Logs (Topics)', async () => {
      await runTest({
        name: 'getLogs (topics)',
        method: c =>
          c.logs.getLogsByTopics({
            fromBlock: 100,
            toBlock: 200,
            topic0: VALID_BLOCK_HASH,
            topic0_1_opr: 'and',
          }),
        expectedParams: {
          module: 'logs',
    ...
    it('Get Logs (Address + Topics)', async () => {
      await runTest({
        ...
        method: c =>
          c.logs.getLogsByAddressAndTopics({
            address: VALID_ADDRESS,
            fromBlock: 100,
            toBlock: 200,
            topic0: VALID_BLOCK_HASH,
  ...
  describe('Proxy Endpoints', () => {
    ...
    it('eth_getStorageAt', async () => {
      await runTest({
        ...
        method: c =>
          c.proxy.getStorageAt({
            address: VALID_ADDRESS,
            position: VALID_HEX_VALUE,
            tag: 'latest',
          }),
        expectedParams: {
          module: 'proxy',
  ...
  describe('Stats Endpoints', () => {
    ...
    it('Get Total Supply of Ether 2', async () => {
      await runTest({
        ...
        mockResponse: {
          status: '1',
          message: 'OK',
          result: { EthSupply: '0', Eth2Staking: '0', BurntFees: '0', WithdrawnTotal: '0' },
        },
      });
    });
    ...
    it('Get Ether Last Price', async () => {
      await runTest({
        ...
        mockResponse: {
          status: '1',
          message: 'OK',
          result: { ethbtc: '0', ethbtc_timestamp: '0', ethusd: '0', ethusd_timestamp: '0' },
        },
      });
    });
    ...
    it('Get Daily Transaction Fee', async () => {
      await runTest({
        name: 'dailytxnfee',
        method: c =>
          c.stats.getDailyTxnFee({ startdate: '2019-02-01', enddate: '2019-02-28', sort: 'desc' }),
        expectedParams: {
          module: 'stats',
          action: 'dailytxnfee',
          startdate: '2019-02-01',
    ...
    it('Get Daily Network Utilization', async () => {
      await runTest({
        ...
        method: c =>
          c.stats.getDailyNetUtilization({
            startdate: '2019-02-01',
            enddate: '2019-02-28',
            sort: 'desc',
          }),
    ...
    it('Get Daily Transaction Count', async () => {
      await runTest({
        name: 'dailytx',
        method: c =>
          c.stats.getDailyTx({ startdate: '2019-02-01', enddate: '2019-02-28', sort: 'desc' }),
        expectedParams: {
          module: 'stats',
          action: 'dailytx',
          startdate: '2019-02-01',
    ...
    it('Get Daily Avg Network Difficulty', async () => {
      await runTest({
        ...
        method: c =>
          c.stats.getDailyAvgNetDifficulty({
            startdate: '2019-02-01',
            enddate: '2019-02-28',
            sort: 'desc',
          }),
  ...
  describe('Token Endpoints', () => {
    ...
    it('Get Token Supply History', async () => {
      await runTest({
        ...
        method: c =>
          c.tokens.getTokenSupplyHistory({ contractaddress: VALID_ADDRESS, blockno: 123 }),
        expectedParams: {
          module: 'stats',
    ...
    it('Get Token Holder List', async () => {
      await runTest({
        ...
        method: c =>
          c.tokens.getTokenHolderList({ contractaddress: VALID_ADDRESS, page: 1, offset: 10 }),
        expectedParams: {
          module: 'token',
    ...
    it('Get Top Token Holders', async () => {
      await runTest({
        ...
        expectedParams: {
          ...
          contractaddress: VALID_ADDRESS,
          offset: 100,
        }, // Spec doc says action=topholders
        mockResponse: { status: '1', message: 'OK', result: [] },
      });
    });
  });
  ...
  describe('Gas Tracker Endpoints', () => {
    ...
    it('Get Daily Avg Gas Limit', async () => {
      await runTest({
        ...
        method: c =>
          c.gasTracker.getDailyAvgGasLimit({
            startdate: '2019-02-01',
            enddate: '2019-02-28',
            sort: 'desc',
          }),
    ...
    it('Get Daily Avg Gas Price', async () => {
      await runTest({
        ...
        method: c =>
          c.gasTracker.getDailyAvgGasPrice({
            startdate: '2019-02-01',
            enddate: '2019-02-28',
            sort: 'desc',
          }),
  ...
  describe('Usage Endpoints', () => {
    it('Chainlist', async () => {
      ...
      await runTest({
        ...
        mockResponse: {
          comments:
            'List of API endpoints maintained by Etherscan EAAS. Available Status codes are (0)=Offline, (1)=Ok, (2)=Degraded',
          totalcount: 66,
          result: [],
        },
      });
